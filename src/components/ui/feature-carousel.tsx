...
export const FeatureCarouselHero = React.forwardRef<HTMLDivElement, HeroProps>(
  ({ title, subtitle, images, cta, className, ...props }, ref) => {
    ...
    return (
      <div
        ref={ref}
        className={cn(
          "relative w-full min-h-[92vh] flex flex-col items-center justify-center overflow-x-hidden bg-background text-foreground p-4",
          className,
        )}
        {...props}
      >
        ...
        <div className="z-10 flex w-full flex-col items-center text-center space-y-8 md:space-y-12 py-16">
            ...
            <div className="relative w-full h-full flex items-center justify-center [perspective:1000px]">
              {images.map((image, index) => {
                ...
                return (
                  <div
                    key={index}
                    className="absolute w-48 h-96 md:w-64 md:h-[450px] transition-all duration-500 ease-in-out flex items-center justify-center"
                    style={{
...
FeatureCarouselHero.displayName = "FeatureCarouselHero"
