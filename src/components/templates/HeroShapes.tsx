...
/**
 * HeroShapes – elegante floating gradient-shapes på mørk bakgrunn.
 * Stor animert sentrert tittel. Passer til kreative byråer og designfirmaer.
 */
export default function HeroShapes({ config }: { config: Config }) {
  return (
    <section
      id="top"
      className="relative min-h-[92vh] w-full flex items-center justify-center overflow-hidden bg-[#030303]"
    >
      ...
      <div className="relative z-10 container mx-auto px-4 md:px-6">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <motion.div custom={3} variants={fadeUpVariants} initial="hidden" animate="visible" className="flex flex-col sm:flex-row gap-3 justify-center">
            <a
              href="#kontakt"
