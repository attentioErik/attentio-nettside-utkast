...
export default function WowHeroSection({ config }: { config: Config }) {
  return (
    <section id="top" className="relative min-h-[92vh] flex items-end overflow-hidden bg-slate-950">
      {config.herobildeSrc && (
        <Image
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(180deg, transparent 30%, rgba(2,6,23,0.65) 75%, rgba(2,6,23,0.95) 100%)",
        }}
        aria-hidden="true"
      />

      <div className="relative z-10 w-full max-w-6xl mx-auto px-4 sm:px-6 pt-28 pb-16 sm:pb-24">
